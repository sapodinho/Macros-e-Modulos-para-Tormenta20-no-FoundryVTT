/**
 * Gera os 6 atributos do D20 e envia eles para um tabela no chat.
 * Editado a partir do macro de @Kekilla#7036 & KrishMero1792
 */
...
let content = `
  <table>
    <tr>
      <td ${colspan}><h2 style="margin-bottom:0; ${center}">Taleba de Atributos</h2>
      <div style="margin-bottom: 0.5rem; ${center}">${statString} foram rolados ${numRolls} vezes.</div></td>
    </tr>
    ...
    <tr style="border-top: 1px solid #000">
      <th colspan="${rolls.length}" style="${center}">Soma total:</th>
